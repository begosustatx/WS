...
<script type="text/javascript" language = "javascript">
		...
		function galderakIkusi(){
			xhro.open("GET","showQuestionsAJAX.php"?testua=+str&zailtasun=+str&gaiarloa=+str&, true);
			xhro.send();
		}
		...
		function galderaGehitu(){
			xhro.open("GET","addQuestionAJAX.php?"testua=+str&eZuzen==+str&eOker1=+str&eOker2=+str&eOker3=+str&zailtasun=+str&gaiarloa=+str, true);
			xhro.send();
		}
</script>
   <?php
